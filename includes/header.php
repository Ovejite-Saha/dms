    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navMain">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item"><a class="nav-link <?= isActive('upload_document.php') ?>" href="<?= $base ?>/subadmin/upload_document.php"><i class="fa-solid fa-upload"></i> Doc_Upload</a></li>
                ...
                <li class="nav-item"><a class="nav-link <?= isActive('upload_bmdata.php') ?>" href="<?= $base ?>/subadmin/upload_bmdata.php"><i class="fa-solid fa-upload"></i> BM_Upload</a></li>
