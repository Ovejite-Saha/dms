...
$bmCount      = $pdo->query("SELECT COUNT(*) FROM pwd_benchmark")->fetchColumn();
...
<div class="container">
    ...
    <div class="d-flex gap-2 mt-3">
        ...
        <a href="upload_bmdata.php" class="btn btn-primary"><i class="fa-solid fa-upload"></i> Upload New Benchmark</a>
        <a href="manage_bmdata.php" class="btn btn-outline-primary"><i class="fa-solid fa-file-lines"></i> Manage Benchmark</a>
    </div>
</div>
