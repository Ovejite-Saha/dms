...
$params = [];
if ($search !== '') {
    $sql .= " AND (d.document_name LIKE ? OR d.building_name LIKE ? OR p.name LIKE ? OR m.name LIKE ? OR u.name LIKE ? OR COALESCE(dtype.name, d.document_name) LIKE ?)";
...
<div class="container">
  ...
  <form method="get" class="mb-4" id="filterForm">
    <div class="search-bar d-flex flex-nowrap align-items-center gap-1" style="overflow-x:auto; padding-bottom:4px;">
      <select name="ministry_id" class="form-select form-select-sm" style="min-width:140px;max-width:160px;">
      ...
      <select name="division_id" id="filter_division" class="form-select form-select-sm" style="min-width:140px;max-width:160px;">
      ...
      <select name="district_id" id="filter_district" class="form-select form-select-sm" style="min-width:140px;max-width:160px;">
      ...
      <select name="upazila_id" id="filter_upazila" class="form-select form-select-sm" style="min-width:140px;max-width:160px;">
      ...
      <select name="project_id" class="form-select form-select-sm" style="min-width:140px;max-width:160px;">
      ...
      <select name="document_type_id" class="form-select form-select-sm" style="min-width:140px;max-width:160px;">
    ...
    <?php foreach ($documents as $d): ?>
      <div class="col-lg-3 col-md-4 col-sm-6">   <!-- 4 columns -->
        <div class="doc-card">
          ...
          <div class="doc-name"><?= htmlspecialchars(($d['document_type_name'] ?? $d['document_name']) . '_' . ($d['building_name'] ?? '')) ?></div>
              ...
              <div class="modal-body">
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" name="building_name" class="form-control" value="<?= htmlspecialchars($d['building_name'] ?? '') ?>" required>
                  </div>
                  <div class="col-md-6">
                    ...
                    <select name="document_type_id" class="form-select" required>
                      ...
                      <?php foreach ($documentTypes as $t): ?>
                        <option value="<?= $t['id'] ?>" <?= (int)($d['document_type_id'] ?? 0) === (int)$t['id'] ? 'selected' : '' ?>><?= htmlspecialchars($t['name']) ?></option>
                      <?php endforeach; ?>
                    </select>
                  </div>
                  <div class="col-md-6">
