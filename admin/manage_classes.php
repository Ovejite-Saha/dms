...
$allowed = ['ministry','division','district','upazila','project','document_type'];
...
try {
    $documentTypes = $pdo->query("SELECT * FROM document_types ORDER BY name")->fetchAll();
...
<div class="container">
  ...
  <ul class="nav nav-tabs mb-3">
    <?php
    $tabs = ['ministry'=>'Ministries','division'=>'Divisions','district'=>'Districts','upazila'=>'Upazilas','project'=>'Projects','document_type'=>'Document Types'];
